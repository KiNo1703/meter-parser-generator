    ...
    objectGroups: [
        {
            ...
            objects: [
                ...
                { id: 5, name: 'A+ T2', obis: '1.0.1.8.4.255', desc: 'Активная энергия потребление T4', type: 'UINT32' },
        ...
        },
        {
            ...
            objects: [
                ...
                { id: 10, name: 'R- T0 (сумма)', obis: '0.0.96.5.1.255', desc: 'Флаг качества сети', type: 'UINT8' }
            ]
        },
        {
            name: '📋 Качество сети',
